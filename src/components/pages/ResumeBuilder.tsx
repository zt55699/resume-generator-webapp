...
const ResumeBuilder: React.FC<ResumeBuilderProps> = ({
  ...
  useEffect(() => {
    ...
    if (templateId) {
      const selectedTemplate = [...resumeTemplates, ...templates].find(
        t => t.id === templateId
      );
      if (selectedTemplate) {
          ...
          {!isPreviewMode && (
            <div className='form-section'>
              ...
              <div className='form-content'>
                <DynamicForm
                  fields={fieldConfigs.filter(
                    f => f.section === selectedSection
                  )}
                  data={
          ...
          <div className='preview-section'>
            <div className='preview-header'>
              ...
              <div className='preview-controls'>
                ...
                <button className='fullscreen-button' title='Fullscreen'>
                  ⛶
                </button>
              </div>
            </div>
