...
const ExportPage: React.FC<ExportPageProps> = ({ templates }) => {
  ...
  const [exportFormat, setExportFormat] = useState<'pdf' | 'docx' | 'html'>(
    'pdf'
  );
  ...
  const handleExport = async (format: 'pdf' | 'docx' | 'html') => {
    ...
    try {
      ...
      switch (format) {
        case 'pdf':
          const { default: PDFExporter } = await import(
            '../export/PDFExporter'
          );
          exporter = PDFExporter;
          break;
        case 'docx':
          const { default: DocxExporter } = await import(
            '../export/DocxExporter'
          );
          exporter = DocxExporter;
          break;
        case 'html':
          const { default: HTMLExporter } = await import(
            '../export/HTMLExporter'
          );
    ...
    <div className='export-page'>
      <div className='export-header'>
        <div className='header-content'>
          ...
          <p className='page-description'>{t('export.subtitle')}</p>
        </div>
      </div>
          ...
          <div className='export-options'>
            <ExportManager
              ...
              onExport={(format: string, success: boolean) => {
                ...
                console.log(
                  `Export ${format} ${success ? 'succeeded' : 'failed'}`
                );
              }}
            />
          </div>
      ...
      <div className='export-tips'>
        ...
        <div className='tips-grid'>
          <div className='tip'>
            <strong>PDF:</strong> Best for job applications and ATS systems.
            Maintains exact formatting.
          </div>
          <div className='tip'>
            <strong>Word:</strong> Perfect if recruiters need to edit or add
            comments to your resume.
          </div>
          <div className='tip'>
            <strong>HTML:</strong> Great for online portfolios and sharing via
            web links.
          </div>
          <div className='tip'>
            <strong>Pro Tip:</strong> Always review your resume after export to
