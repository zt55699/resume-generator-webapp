...
const MyResumes: React.FC = () => {
  ...
  const handleResumeAction = async (action: 'view' | 'edit' | 'share' | 'export' | 'delete', resumeId: string) => {
        ...
        <div className="header-content">
          <div className="header-left">
            ...
            <p className="page-description">
              Manage your published resumes, track views, and share with potential employers.
            </p>
          </div>
                ...
                <div className="card-content">
                  ...
                  <div className="resume-meta">
                    ...
                    <div className="meta-item">
                      ...
                      <span className="meta-value">{formatDate(resume.publishedAt)}</span>
                    </div>
                    <div className="meta-item">
