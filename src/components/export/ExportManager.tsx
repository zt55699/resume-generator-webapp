...
const ExportManager: React.FC<ExportManagerProps> = ({
  ...
  const [exportFormat, setExportFormat] = useState<'html' | 'pdf' | 'docx'>(
    'pdf'
  );
    ...
    <div className='export-manager'>
            ...
            <div className='option-group'>
              <label className='option-checkbox'>
                <input
                  ...
                  onChange={e =>
                    handleOptionChange('includeProfilePhoto', e.target.checked)
                  }
                />
              ...
              <label className='option-checkbox'>
                <input
                  ...
                  onChange={e =>
                    handleOptionChange(
                      'includePortfolioVideos',
                      e.target.checked
                    )
                  }
                  disabled={exportFormat === 'pdf' || exportFormat === 'docx'}
                />
                Include portfolio videos{' '}
        ...
        {showPreview && (
          <div className='export-preview'>
            ...
            <div className='preview-note'>
              <small>
                This is a scaled preview. The actual export will be full size.
              </small>
            </div>
          </div>
        )}
      ...
      <div className='export-tips'>
        ...
        <ul className='tips-list'>
          <li>
            <strong>PDF:</strong> Best for job applications and printing.
            Preserves exact formatting.
          </li>
          <li>
            <strong>DOCX:</strong> Choose this if you need to edit the content
            later in Word.
          </li>
          <li>
            <strong>HTML:</strong> Perfect for online portfolios and email
            attachments.
          </li>
          <li>
            <strong>Images:</strong> Large images increase file size. Consider
            unchecking if not needed.
          </li>
          <li>
            <strong>Print Quality:</strong> Use "High" quality for final
            versions, "Low" for quick previews.
          </li>
        </ul>
      </div>
    </div>
