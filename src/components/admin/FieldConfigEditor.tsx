...
const FieldConfigEditor: React.FC<FieldConfigEditorProps> = ({
  ...
  const handleDeleteField = (fieldId: string) => {
    if (window.confirm('Are you sure you want to delete this field?')) {
      const updatedConfigs = fieldConfigs.filter(
        ...
        {sortedConfigs.map(config => (
          <div key={config.id} className='field-config-item'>
            <div
              ...
              onClick={() =>
                setExpandedField(expandedField === config.id ? null : config.id)
              }
            >
                  ...
                  <div className='form-group'>
                    <div className='checkbox-group'>
                      <input
                        ...
                        onChange={e =>
                          handleFieldChange('visible', e.target.checked)
                        }
                      />
                  ...
                  {['file', 'image', 'video'].includes(editingField.type) && (
                    <>
                      ...
                      <div className='form-group'>
                        ...
                        <textarea
                          value={(
                            editingField.fileConfig?.acceptedTypes || []
                          ).join(', ')}
                          onChange={e =>
                            handleFileConfigChange(
                              'acceptedTypes',
