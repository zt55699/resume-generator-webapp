...
const App: React.FC = () => {
  const [fieldConfigs, setFieldConfigs] =
    useState<FieldConfig[]>(defaultFieldConfigs);
  ...
  return (
    <LanguageProvider>
      <ResumeProvider>
        <Router>
          <div
            className={`app ${isWeChat ? 'wechat-env' : ''} ${isMiniProgram ? 'wechat-miniprogram' : ''} ${deviceInfo.isMobile ? 'mobile-env' : ''}`}
          >
            ...
            <main
              className={`app-main ${isMiniProgram ? 'safe-area-support' : ''}`}
            >
              <Routes>
                ...
                <Route
                  path='/builder'
                  element={<ResumeForm fieldConfigs={fieldConfigs} />}
                />
                <Route
                  path='/preview'
                  element={<ResumePreview templates={templates} />}
                />
                <Route
                  path='/export'
                  element={<ExportPage templates={templates} />}
                />
            ...
            {!isMiniProgram && (
              <footer className='app-footer'>
                ...
                <div className='footer-bottom'>
                  <p>
                    &copy; 2024 Resume Generator. Built with React and
                    TypeScript.
                  </p>
                </div>
              </footer>
